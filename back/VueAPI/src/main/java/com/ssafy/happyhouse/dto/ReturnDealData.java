...
public class ReturnDealData {
	...
	public ReturnDealData() {

	}

	public ReturnDealData(int dealNo, String aptName, String address, String dealDate, String price, String area,
